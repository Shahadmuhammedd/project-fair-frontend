...
function AddProject() {
  ...
  return (
    <div>
      <button className='btn btn-light text-dark mt-5 ' onClick={handleShow}>Add</button>
      <Modal
        show={show}
        onHide={handleClose}
        backdrop="static"
      ...
      >
        ...
        <Modal.Body>
          ...
          <img width={'300px'} src="https://media1.giphy.com/media/qgQUggAC3Pfv687qPC/giphy.gif" alt="" />
        </label>
            </div>
